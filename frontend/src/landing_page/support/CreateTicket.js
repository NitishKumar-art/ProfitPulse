    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <h4 className=""><i class="fa fa-plus-circle" aria-hidden="true"></i>
          ...
          <a href=""style={{textDecoration:"none", lineHeight:"2.5"}}>Changes at ProfitPulse</a><br/>
          <a href=""style={{textDecoration:"none", lineHeight:"2.5"}}>ProfitPulse IDFC FIRST Bank 3-in-1 Account</a><br/>
          <a href=""style={{textDecoration:"none", lineHeight:"2.5"}}>Getting Started</a><br/>
      </div>
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className=""><i class="fa fa-user" aria-hidden="true"></i>
          Your ProfitPulse Account
        </h4>
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className=""><i class="fa fa-circle-o-notch" aria-hidden="true"></i>
          Console
        </h4>
          ...
          <a href=""style={{textDecoration:"none", lineHeight:"2.5"}}>Fund Statement</a><br/>
          <a href=""style={{textDecoration:"none", lineHeight:"2.5"}}>Reports</a><br/>
          <a href=""style={{textDecoration:"none", lineHeight:"2.5"}}>Profile</a><br/>
          <a href=""style={{textDecoration:"none", lineHeight:"2.5"}}>Segment</a><br/>
      </div>
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className=""><i class="fa fa-circle-o" aria-hidden="true"></i> 
          ...
          <a href=""style={{textDecoration:"none", lineHeight:"2.5"}}>Payments ans Orders</a><br/>
          <a href=""style={{textDecoration:"none", lineHeight:"2.5"}}>General</a><br/>
      </div>
      </div>
    </div>
